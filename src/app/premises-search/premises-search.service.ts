...
export class PremisesSearchService {
    ...
    public setRandomNumber(max: number) {
      return Math.floor(Math.random() * max);
    }

    public setRandomBoolean(id: number){
      if (id % 2 === 0){ return true }
      else{ return false}
    }

    public setRandomMod(number: number){
      switch (number){
        case 0: return 'YAR';
        case 1: return 'NT';
        case 2: return 'OB2';
    ...
    public setRandomString(length: number){
      let str = '';
    ...
    public createObject(number:number){
      switch (number){
        case 0: return this.createFlat();
        case 1: return  this.createOffice();
        case 2: return this.createGarage();
        default: return null;
      }
    }
}
